...
export function useCanvasStream({ streamingData, setCanvas }: { streamingData: JSONValue[] | undefined; setCanvas: Dispatch<SetStateAction<UICanvas>> }) {
      ...
      switch (delta.type) {
        ...
        case 'text-delta':
          return {
            ...
            isVisible: draftCanvas.status === 'streaming' ? true : draftCanvas.content.length > 200,
            status: 'streaming',
          }

        case 'suggestion':
          setTimeout(() => {
            setOptimisticSuggestions((currentSuggestions) => [...currentSuggestions, delta.content as Suggestion])
          }, 0)
